<?php
    ...
    if($dni == "" || $nombre == "" || $apellido == "" || $direccion == "" || $usuario == "" || $email == "")
    {
        ...
        header("location:".APP_URL."/vistas/administrativos/edit.php?id=$id_persona");
    }
    else
    {
        ...
        else
        {
            ...
            f_nacimiento=:f_nacimiento,profesion=:profesion,fyh_actualizacion=:fecha WHERE id_personas=:id_persona");
            ...
            //*************** ACTUALIZA EN LA TABLA ADMINISTRATIVOS ***************//
            $sentencia = $pdo->prepare("UPDATE administrativos SET fyh_actualizacion=:fecha WHERE id_administrativos=:id_administrativo");
            ...
            if($sentencia->execute())
            {
                $pdo->commit();
                session_start();
                $_SESSION['mensaje'] = "El personal administrativo se actualizo correctamente.";
            ...
            else
            {
                $pdo->rollBack();
                session_start();
                $_SESSION['mensaje'] = "No se pudo actualizar al personal administrativo, comuníquese con el Administrador.";
                $_SESSION['icono'] = "error";
