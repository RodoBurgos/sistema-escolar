                ...
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                          <a href="create.php" class="btn btn-primary" title="Nuevo rol"><i class="fas fa-plus"></i> Crear nuevo rol</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table id="tabla-roles" class="table table-bordered table-striped table-sm">
                            <thead>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $rol["fyh_creacion"];?></td>
                                            <td class="text-center"><?php echo $rol["fyh_actualizacion"];?></td>
                                            <td class="text-center">
                                                <form action="<?php echo APP_URL;?>/controllers/roles/eliminar_roles.php" method="POST" class="formulario-eliminar">
                                                  <a href="show.php?id=<?php echo $id_rol;?>" class="btn btn-outline-info btn-sm" title="Ver"><i class="fas fa-eye"></i></a>
                                                  <a href="edit.php?id=<?php echo $id_rol;?>" class="btn btn-outline-success btn-sm" title="Editar"><i class="fas fa-edit"></i></a>
                                                  <input type="text" value="<?php echo $id_rol;?>" name="id_rol" hidden>
...
<script>
  $(document).ready(function()
  {
    ...
    $('.formulario-eliminar').submit(function(e)
    {
      ...
      Swal.fire({
          title: '¿Estás seguro de eliminar éste rol?',
