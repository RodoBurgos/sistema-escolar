  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Datos del personal administrativo: <b><?php echo $nombre_persona.' '.$apellido_persona;?></b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo APP_URL?>/vistas/">Inicio</a></li>
              <li class="breadcrumb-item active">Datos del personal administrativo</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <a href="<?php echo APP_URL;?>/vistas/administrativos/" class="btn btn-secondary">Volver</a>
                            </div>
                          </div>
                    </div>
                </div>
