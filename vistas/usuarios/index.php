                ...
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                          <a href="create.php" class="btn btn-primary" title="Nuevo usuario"><i class="fas fa-plus"></i> Crear nuevo usuario</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table id="tabla-usuarios" class="table table-bordered table-striped table-sm">
                            <thead>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="<?php echo APP_URL;?>/controllers/usuarios/eliminar_usuarios.php" method="POST" class="formulario-eliminar">
                                                  <a href="show.php?id=<?php echo $id_usuario;?>" class="btn btn-outline-info btn-sm" title="Ver"><i class="fas fa-eye"></i></a>
                                                  <a href="edit.php?id=<?php echo $id_usuario;?>" class="btn btn-outline-success btn-sm" title="Editar"><i class="fas fa-edit"></i></a>
